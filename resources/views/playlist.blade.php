                ...
                <div v-for="card in cards" class="flex flex-col md:flex-row overflow-hidden bg-white rounded-lg shadow-xl  mt-4 w-100 mx-2">
                    ...
                    <div class="w-full p-8 text-gray-800 flex flex-col justify-between">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                <a class="px-8 pt-3 pb-2 leading-5 transition-colors duration-150 bg-tertiary border border-transparent rounded-full active:bg-tertiary hover:bg-tertiary focus:outline-none focus:shadow-outline-tertiary font-optima uppercase italic font-extrabold text-sm shadow-hard" href="/playlist/{{ $playlistId }}">

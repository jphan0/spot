    ...
    <section>
        <div class="max-w-3xl px-6 pt-4 md:pt-8 mx-auto font-itc-garamond" x-data="{ show: false }">
            ...
            <p class="py-4 text-2xl">
                Vacay Tunes searches Spotify for your favourite songs and playlists and finds the closest matching YouTube video(s). The audio is then extracted from the video(s) and converted to an M4A file for you to download and take on your next vacay!
            </p>
